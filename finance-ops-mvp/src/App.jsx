...
function Layout({children}){
  ...
  return (
    <div>
      <div className="nav">
        <div style={{fontWeight:700}}>Finance Ops MVP</div>
        ...
        <div style={{marginLeft:'auto'}}>
          {me ? (
            <>
              <span className="small">Signed in as {me.name} ({me.role})</span>{' '}
...
function RequireAuth({children}){
  const st = getState()
  return st.me ? children : <Navigate to="/login" replace />
}
...
export default function App(){
  return (
    <Routes>
      ...
      <Route element={<Layout><OutletShim/></Layout>}>
